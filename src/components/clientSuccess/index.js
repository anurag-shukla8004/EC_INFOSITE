...
Some of our happy customers from different businesses are:
    ...
    <div className='modalName' onClick={handleClick1}> &nbsp;<AiFillCaretDown />&nbsp;  Agriculture</div>
    ...
    <div className='modalContainer' >
    <div className='modalName' onClick={handleClick2}> &nbsp;<AiFillCaretDown />&nbsp;    Education</div>
    ...
    <div className='modalContainer' >
    <div className='modalName'onClick={handleClick3}> &nbsp;<AiFillCaretDown />&nbsp;    Engineering</div>
    ...
    <div className='modalContainer' >
    <div className='modalName'onClick={handleClick4}>&nbsp;<AiFillCaretDown />&nbsp;   Financial Services</div>
    ...
    <div className='modalContainer' >
    <div className='modalName'onClick={handleClick5}> &nbsp;<AiFillCaretDown />&nbsp;   Government</div>
   <div className='modalLink' style={{display: isShown5 ? 'flex' : 'none',padding: '15px', flexWrap:'wrap'}}>
    ...
    <img className='partnerImg' src='gov3.jpeg'></img></div>
    </div>
    <div className='modalContainer' >
    <div className='modalName'onClick={handleClick6}> &nbsp;<AiFillCaretDown />&nbsp;    Healthcare</div>
    ...
    <img className='partnerImg' src='health15.png'></img></div>
    </div>
    <div className='modalContainer' >
    <div className='modalName'onClick={handleClick7}> &nbsp;<AiFillCaretDown />&nbsp;    Media</div>
    ...
    <div className='modalContainer'>
    <div className='modalName' onClick={handleClick8}> &nbsp;<AiFillCaretDown />&nbsp;   Non Profit</div>
    ...
    <div className='modalContainer' >
    <div className='modalName'onClick={handleClick9}> &nbsp;<AiFillCaretDown />&nbsp;    Real Estate</div>
    ...
    <img className='partnerImg' src='re10.png'></img></div>
    </div>
    <div className='modalContainer' >
    <div className='modalName' onClick={handleClick10}> &nbsp;<AiFillCaretDown />&nbsp;   Services</div>
   <div className='modalLink' style={{display: isShown10 ? 'flex' : 'none',padding: '15px', flexWrap:'wrap'}}> 
    ...
    <img className='partnerImg' src='se8.png'></img></div>
    </div>
    <div className='modalContainer' >
    <div className='modalName'onClick={handleClick11}> &nbsp;<AiFillCaretDown />&nbsp;   Shipping & Logistics</div>
    ...
    <img className='partnerImg' src='sh4.png'></img></div>
    </div>
    <div className='modalContainer' >
    <div className='modalName'onClick={handleClick12}> &nbsp;<AiFillCaretDown />&nbsp;  Software</div>
 <div className='modalLink' style={{display: isShown12 ? 'flex' : 'none',padding: '15px', flexWrap:'wrap'}}> 
    ...
    <div className='modalContainer' >
    <div className='modalName'onClick={handleClick13}> &nbsp;<AiFillCaretDown />&nbsp;   Travel & Hospitality</div>
