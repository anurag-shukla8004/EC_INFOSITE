...
function googleCloudPage({}) {
  return (
    <div>
      <div className="glImg">
        <img src="/assets/glCloud1.png"></img>
      </div>
      <div className="homeMainContainer">
          ...
          <div className="gl">
            ...
            <div className="glBox">
              ...
              <div className="glservebox">
                ...
                <div className="glLine"></div>
                <div className="glServeMainBox">
                <div className='googleIcon'> <FontAwesomeIcon
                    icon={faLaptop}
                    style={{
                      fontSize: 25,
                      color: '0065cd',
          ...
          BENEFITS OF GOOGLE WORKSPACE
            ...
            <div className='glBox'>
               <div className='glBenifitBox'>
                 <img src='/assets/glb1.png'></img>
                 <h1 className='glBenifitHeading'>Data Security</h1>
                 <p className='glSmallPara'> Google Workspace allows users to store, access, manage and share their data files. It protects business data even if it is lost.</p>
               </div>
               <div className='glBenifitBox'>
                 <img src='/assets/glb2.png'></img>
                 <h1 className='glBenifitHeading'>Secure sharing</h1>
                 <p className='glSmallPara'>Google documents and data files can be shared with anyone easily. Enabling view-only access allows you to protect the accessibility of another person.</p>
               </div>
               <div className='glBenifitBox'>
                 <img src='/assets/glb3.png'></img>
                 <h1 className='glBenifitHeading'>Unlimited storehouse</h1>
                 <p className='glSmallPara'>Google Workspace provides unlimited storehouse for your applications, data, files, docs, media, and other. This will help an end user to store everything they require.</p>
               </div>
            </div>
            <div className='glBox'>
               <div className='glBenifitBox'>
                 <img src='/assets/glb4.png'></img>
                 <h1 className='glBenifitHeading'>Affordable Plan</h1>
                 <p className='glSmallPara'>G Suite monthly and yearly subscription are very affordable for mid and large scale organizations, users can use aspects such as limitless data storage, secure data protection, eDiscovery potential, and other.</p>
               </div>
               <div className='glBenifitBox'>
                 <img src='/assets/glb5.png'></img>
                 <h1 className='glBenifitHeading'>Custom Business Email ID</h1>
                 <p className='glSmallPara'>user will be able to use a custom email address at a domain (name@yourcompany.com). Insead of name@gmail.com.</p>
               </div>
               <div className='glBenifitBox'>
                 <img src='/assets/glb6.png'></img>
                 <h1 className='glBenifitHeading'>Integration with CRM platform</h1>
                 <p className='glSmallPara'>G Suite is well matched & compatible with CRM integration. This feature is useful for creating report where organizations can track leads and other data.</p>
               </div>
            </div>
            </div>
          </div>
        ...
        <div className="homeContainer">
            <div className='gl'>
              ...
              <div className="glTextBox">
              <div>
          <h2 className='questionTitle'>How Much G Suite Cost?
</h2>
          <p className='questonPara'>G Suite has been a very powerful, yet straight-forward tool to run any business. Google G Suite pricing starts from $10 per user per month. in a different way, around $120* a year if you’re a business owner. In return, you get 1 TB per user of online storehouse—or limitless storage if there are five or more in your corporation.

</p>
        </div>
        <div>
          <h2 className='questionTitle'>What is Google Workspace?
</h2>
          <p className='questonPara'>Google Workspace is a collection that Google has created and marketed to include cloud computing, productivity, and collaboration tools. It was originally launched as Google Apps for Your Domain in 2006. In 2016, it was rebranded as G Suite.

</p>
        </div>
        <div>
          <h2 className='questionTitle'>How do you Log into Google Cloud?
</h2>
          <p className='questonPara'>1. Go to the Cloud Console Users Page. Go to the Users Page. 2. Click on Add user. 3. Enter your email address and password. 4. Save. Click Save.

</p>
        </div>
        <div>
          <h2 className='questionTitle'>How Much Storage Space is Available to G suite?
</h2>
          <p className='questonPara'>Each user receives G Suite Basic and Business Starter.Storage of 30 GBGoogle Drive, Gmail and Google Photos can be used. Administrators can allow users to buy additional storage.

</p>
        </div>
        <div>
          <h2 className='questionTitle'>How to Configure G Suite in Outlook?
</h2>
          <p className='questonPara'>1.On your computer, log into the Google Web App. 2. In the top right, and click Settings. 3. Clack Forwarding and POP/IMAP tab. 4. In the “IMAP Access” section, activate IMAP. 5. Save Changes.

</p>
        </div>
        <div>
          <h2 className='questionTitle'>What is G Suite Basic?
</h2>
          <p className='questonPara'>G Suite Basic edition is a suite of collaborative productivity application that offers your work pro email, shared calendars, virtual information editing and storage, video conference, and others.

</p>
        </div>
        <div>
          <h2 className='questionTitle'>What is Included in G Suite?
</h2>
          <p className='questonPara'>The standard G Suite tools include Gmail, Drive, Docs, Sheets, Slides, Forms, Calendar, Google+, Sites, Hangouts.

</p>
        </div>
        <div>
          <h2 className='questionTitle'>How Many Users G Suite Basic?
</h2>
          <p className='questonPara'>g suite basic and corporate can add 50 person in a call, while Enterprise can, in addition to adding 100 users, record gathering and save them to Drive. Moreover, Enterprise-users can dial-in from a phone

</p>
        </div>
        <div>
          <h2 className='questionTitle'>Who is Google cloud partner in pune?
</h2>
          <p className='questonPara'>EC Infosolutions is a Google-authorized partner for providing G Suite services in Pune & Mumbai. With G Suite, your organization will get customized email addresses (with Gmail for business), video conferencing, cloud storage, calendar, mobile email via Android for work, and IM access. It is easy to setup, use, & manage, and enables you to work smoother, smarter, and concentrate on tasks that matter the most to your business.

</p>
        </div>
        <div>
          <h2 className='questionTitle'>How do i Access My Google Business Email?
</h2>
          <p className='questonPara'>to access google business email, visit any web browser, go to admin.google.com. starting from the sign in page- enter your correct email id and password for your admin account.
